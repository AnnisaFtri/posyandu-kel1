  ...
  <div class="container">
    <nav style="position:fixed;">
      <ul>
        ...
        <li><a href="http://127.0.0.1:8000/pemeriksaan">
          <i class="fas fa-wallet"></i>
          <span class="nav-item">Pemeriksaan</span>
        </a></li>
        <li><a href="http://127.0.0.1:8000/jenispelayanan">
        ...
        <li><a href="http://127.0.0.1:8000/log">
          <i class="fas fa-tasks"></i>
          <span class="nav-item">Logs</span>
        </a></li>
        <li><a href="http://127.0.0.1:8000/login " class="logout">
